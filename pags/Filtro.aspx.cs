...
namespace pmLOGIN.pags
{
    public partial class Filtro : System.Web.UI.Page
    {
        ...
        private string txtSede;
        private string txtCarrera;
        private string txtPlan;
        private bool btnEditF, btnEditT;
        private bool btnElimF, btnElimT;
        string rutaArchivo = "~/txtO/arch4optimo.txt";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            tablaProducto.Columns.Add("CARRERA");
            tablaProducto.Columns.Add("JORNADA");
        ...
        protected void btnGUARDAR_Click(object sender, EventArgs e)
        {
...

            {
                ...
                {
                    tablaProducto.Rows.Add(txtCodigo, txtSede, txtCarrera, txtPlan);
                    //agrega los datos al grid
                    GridView1.DataBind();

                    //agregar datos al archivo txt
                    string linea = txtCodigo + "," + txtSede + "," + txtCarrera + "," + txtPlan;
        ...
        public void txtAstr()
        {
            ...
            txtSede = TextBoxCodSede.Text;
            txtCarrera = TextBoxCodCarrera.Text;
            txtPlan = TextBoxCodPlan.Text;
        }
