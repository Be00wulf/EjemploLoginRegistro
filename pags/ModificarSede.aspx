<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModificarSede.aspx.cs" Inherits="pmLOGIN.pags.ModificarSitio" %>
    ...
    <div class="info">
        <main>
            <section class="content-section" aria-labelledby="inventTitle">
                <h1 id="inventTitle">Edición de sedes</h1>
                ...
                <table class="custom-table">
                    ...
                    <tr>
                        <td class="alinD"><asp:Button ID="ButtonLimpiar" runat="server" CssClass="btn-primary " Text="ACTUALIZAR" OnClick="ButtonLimpiar_Click" />
