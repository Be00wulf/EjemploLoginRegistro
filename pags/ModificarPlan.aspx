<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModificarPlan.aspx.cs" Inherits="pmLOGIN.pags.ModificarPlan" %>
...
<div class="info">
    <main>
        <section class="content-section" aria-labelledby="inventTitle">
            <h1 id="inventTitle">Edición de jornadas</h1>
            ...
            <table class="custom-table">
                ...
                <tr>
                    <td class="auto-style2">PLAN: </td>
                    <td class="auto-style4">
                        <asp:TextBox ID="TextBoxProducto" runat="server" CssClass="estilotxtBox" placeholder="Ej: Matutino"></asp:TextBox>
                    </td>
                </tr>
            </table>
